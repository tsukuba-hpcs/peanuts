...
auto main(int argc, char* argv[]) -> int try {
  ...
  auto topo = peanuts::topology{};
  auto rpm =
      peanuts::rpm{topo, params.pmem,
                 peanuts::utils::round_up_pow2(32 + params.io_size_per_proc,
                                             peanuts::rpm::pmem_alignment) *
                     topo.intra_size()};
  // auto ring = peanuts::ring_buffer{rpm};
  auto store = peanuts::bb_store{rpm};
